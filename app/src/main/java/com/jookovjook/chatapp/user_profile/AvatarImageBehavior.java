...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private float mFinalXMargin;
    private float mStartYMargin;
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mStartYMargin = a.getDimension(R.styleable.AvatarImageBehavior_startYMargin, 0);
            mFinalXMargin = a.getDimension(R.styleable.AvatarImageBehavior_finalXMargin, 0);
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        if (mStartYPosition == 0)
            mStartYPosition = (int) (dependency.getY()) + (int) mStartYMargin;

        if (mFinalYPosition == 0)
            mFinalYPosition = (dependency.getHeight() /2) + 22;
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + ((int) mCustomFinalHeight / 2) + (int) mFinalXMargin;
